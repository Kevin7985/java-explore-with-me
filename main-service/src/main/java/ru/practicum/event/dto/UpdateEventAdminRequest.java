...
public class UpdateEventAdminRequest {
    ...
    private final StateActionAdmin stateAction;

    public UpdateEventAdminRequest(String title, String annotation, String description, Long category, LocalDateTime eventDate, Boolean paid, Integer participantLimit, Boolean requestModeration, Location location, StateActionAdmin stateAction) {
